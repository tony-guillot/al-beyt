...
<main>
    <section>
        <section>
            <article>
                <h1>Qu'est ce que le collectif Al-Beyt</h1>
                <p>
            ...
            <article>
                ...
                <div>
                    <ul>
                        <li><a href="https://www.instagram.com/al_beyt_collectif/"><i class="fa-brands fa-instagram"></i></a></li>
                        <li><a href="https://www.facebook.com/Collectif-AL-Beyt-103326081984889"><i class="fa-brands fa-facebook"></i></a>
                        <li><a href="mailto:collectif.albeyt@gmail.com"> <i class="fa-solid fa-envelope"></i></a></li>
                    </ul>
                </div>
            </article>
        </section>
