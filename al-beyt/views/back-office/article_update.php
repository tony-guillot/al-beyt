                            ...
                            <section class="z-depth-1 grey cards lighten-5  col s4 imagesForm">
                                ...
                                <article>
                                    ...
                                    <div class="margin">
                                        ...
                                        <?php else: ?>
                                            <img class="image" style="width:100%"  id="image2" src="../../../images/placeholder.jpg" alt="image vide">
                                        <?php endif ?>
                                    </div>
                                </article>
                                <article>
                            ...
                            <section class="z-depth-1 grey lighten-5 col s4  cards imagesForm">
                                ...
                                <article>
                                    ...
                                    <div class="margin">
                                        ...
                                        <?php else: ?>
                                            <img  style="width:100%"  class="image" id="image2" src="../../../images/placeholder.jpg" alt="image vide">
                                        <?php endif ?>
                                    </div>
                                </article>
                                <article>
